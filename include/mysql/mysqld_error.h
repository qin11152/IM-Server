...
static const int errmsg_section_size[] = { 888, 239, 666, 4055 };

static const int total_error_count = 5848;
...
static const int pfs_session_error_stat_count = 1638;

static const int pfs_global_error_stat_count = 3654;
