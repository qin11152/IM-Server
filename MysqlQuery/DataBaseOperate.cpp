 ...
 * @LastEditTime: 2024-04-09 11:12:24
...
namespace database
{
    ...
    DataBaseOperate::DataBaseOperate(const char *ip, const char *database, const char *user, const char *password) : m_destinationIp(ip),
